        ...
        <form id="roles_form" name="roles_form">
          ...
          <div class="row">
              <div class="col-sm-12 mt-2 mb-2 text-center">
                <button class="btn btn-sm {{$btn}}" id="btnRegresaListadoPerfiles"><i class="fa fa-sm fa-undo"></i> Regresar al listado</button>
                <button class="btn btn-sm {{$btn}}" id="btnGuardaPerfil"><i class="fa fa-sm fa-save"></i> Guardar Perfil</button>
              </div>
          </div>
        </form>
      </div>
...
<script>
  ...
  document.getElementById( 'btnRegresaListadoPerfiles' ).addEventListener( 'click' , function( e ){
    e.preventDefault();
