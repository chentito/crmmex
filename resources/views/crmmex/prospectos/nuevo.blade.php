    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#propuestas" role="tab" aria-controls="contact" aria-selected="false">
                        <i class="fa fa-file fa-sm"></i><span class="d-none d-sm-inline">  Propuestas Comerciales</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#seguimientos" role="tab" aria-controls="contact" aria-selected="false">
                        <i class="fa fa-clipboard fa-sm"></i><span class="d-none d-sm-inline">  Seguimientos</span>
                    </a>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-3 mb-1">
                                    ...
                                    <input type="hidden" id="cliente_tipo" name="cliente_tipo" value="2"><!-- 1 cliente/2 prospecto -->
                                </div>
                                <div class="col-sm-3 mb-1">
                            ...
                            <div class="row">
                                <div class="col-sm-3 mb-1">
                                    ...
                                    <select id="direccion_pais" name="direccion_pais" class="custom-select custom-select-sm">
                                        <option value="0" disabled="disabled">Pa&iacute;s</option>
                ...
                <div class="tab-pane fade" id="propuestas" role="tabpanel" aria-labelledby="contact-tab">
                    <div class="card card-small w-100">
                        <div class="card-body">
                            <table id="propuestasCli" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Contacto</th>
                                        <th>Fecha Envío</th>
                ...
                <div class="tab-pane fade" id="seguimientos" role="tabpanel" aria-labelledby="contact-tab">
                    <div class="card card-small w-100">
                        <div class="card-body">
...
<script>
    $(function () {
        ...
        $('#propuestasCli').DataTable({
            ajax   :{
                url: '/api/listadoPropuestas/1',
                dataSrc: 'propuestas'
            },
            columns: [
                { data: 'contacto' },
