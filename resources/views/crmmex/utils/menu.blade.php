<ul class="list-unstyled components">
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="clientes">
            <li><a href="javascript:void(0)" onclick="return contenidos('clientes_alta');">Altas</a></li>
            <li><a href="javascript:void(0)" onclick="return contenidos('clientes_listado');">Listados</a></li>
