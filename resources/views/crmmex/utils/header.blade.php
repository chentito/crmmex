<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto">
    <li class="nav-item active">
      <a class="nav-link" href="javascript:contenidos('ayuda')" title="Ayuda"><i class="fa fa-sm fa-question"></i></a>
    </li>
    <li class="nav-item active">
    ...
    <li class="nav-item dropdown">
      <a href="#" data-toggle="dropdown" aria-expanded="false" aria-haspopup="true" class="nav-link">
        <img class="rounded-circle" src="{{ asset( '/imagenEjecutivo/' . Auth::user()->id ) }}" alt="Bienvenido(a) {{ Auth::user()->name }} {{ Auth::user()->apPat }}" width="25">
