...
INSERT INTO `crmmex_sis_admins` VALUES (1,'Carlos','Lam','Santiesteban','clam@mexagon.net','420',1,'2019-02-26 00:00:00',1,'2019-02-26 19:13:15'),(2,'José','Gutiérrez','García','jgutierrez@mexagon.net','320',2,'2019-02-26 00:00:00',1,NULL),(3,'Carlos','Reyes','Salazar','cvreyes@mexagon.net','310',2,'2019-02-26 00:00:00',1,NULL),(4,'Lorenzo','Reyes','Cuellar','lorenzo@gmail.com','2912',2,'2019-02-20 00:00:00',1,NULL),(9,'qqqqqqqq','qqqqqq','qqqqqqqq','chentito002@gmail.com','1212',1,'2019-02-26 18:55:24',0,'2019-02-26 22:59:24'),(11,'Uno mas','desde el formulario','de captura','carlosreyes007@yahoo.com.mx','109',3,'2019-02-26 19:13:00',1,NULL),(13,'qweqweqwe','qweqwe','qweqwe','qweqweqwe','qweqweq',1,'2019-02-26 22:13:01',0,'2019-02-26 22:59:27'),(14,NULL,NULL,NULL,NULL,NULL,1,'2019-02-26 22:59:17',0,'2019-02-26 22:59:20');
...
--
-- Table structure for table `crmmex_ventas_clientes`
--

DROP TABLE IF EXISTS `crmmex_ventas_clientes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `crmmex_ventas_clientes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `crmmex_ventas_clientes`
--

LOCK TABLES `crmmex_ventas_clientes` WRITE;
/*!40000 ALTER TABLE `crmmex_ventas_clientes` DISABLE KEYS */;
INSERT INTO `crmmex_ventas_clientes` VALUES (1,1,'Mexagon SA de CV','MEX050512V22',3,1,3,2,'2019-02-25 00:00:00',NULL,1);
/*!40000 ALTER TABLE `crmmex_ventas_clientes` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `crmmex_ventas_propuestacomercial` (
  ...
  `status` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_idx` (`idEjecutivo`),
  KEY `cliente_idx` (`idCliente`),
  CONSTRAINT `cliente` FOREIGN KEY (`idCliente`) REFERENCES `crmmex_ventas_clientes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `id` FOREIGN KEY (`idEjecutivo`) REFERENCES `crmmex_sis_admins` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `crmmex_ventas_propuestacomercial` VALUES (1,1,1,1,'2019-02-22 00:00:00','Se espera confirmacion del cliente en los proximos 3 dias habiles',600,0,0,1);
...
-- Dump completed on 2019-02-27 13:43:51
